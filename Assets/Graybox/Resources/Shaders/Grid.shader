...
Shader "Graybox/Grid" {
	Properties
	{
		...
		_GridColor("Grid Color", Color) = (.8, .8, .8, 0.5)
		_CenterColor("Center Color", Color) = (1, .4, 0, 0.75)
		_StartLevel("Start Zoom Level", Float) = 1.5
		//		_LowestLevel("Lowest Level", Float) = -2
				_GridLineThickness("Grid Line Thickness", Float) = 1.5
				_CenterLineThickness("Center Line Thickness", Float) = 1
